...
<head>
    ...
    <link href="{{asset('home/css/detail.css')}}" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="{{asset('home/script/jquery.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('home/script/common.js')}}"></script>
    <style>
        /*上下滚动*/
        #scrollDiv {
            width: 400px;
...
<header>
    <div class="header-top min-width">
        <div class="container fn-clear"> <strong class="fn-left">咨询热线：400-668-6698<span class="s-time">服务时间：9:00 - 18:00</span></strong>
            <ul class="header_contact">
                <li class="c_1"> <a class="ico_head_weixin" id="wx"></a>
                    <div class="ceng" id="weixin_xlgz" style="display: none;">
                        <div class="cnr"> <img src="{{asset('home/images/code.png')}}"> </div>
            ...
            <ul class="fn-right header-top-ul">
                <li> <a href="{{asset('/')}}" class="app">返回首页</a> </li>
                <li>
    ...
    <div class="header min-width">
        <div class="container">
            <div class="fn-left logo"> <a class="" href="index.html"> <img src="{{asset('home/images/logo.png')}}"  title=""> </a> </div>
            <ul class="top-nav fn-clear">
                <li class="on"> <a href="{{asset('/')}}">首页</a> </li>
                <li> <a href="{{asset('home/invest')}}" class="">我要投资</a> </li>
